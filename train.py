...
from torch import datasets,transforms,models
...
def agr_paser():
    ...
    paser.add_argument('--save dir',type=str,default='checkpoint.pth',help='save trained model to disk')
    
    args=paser.parse_args()
    return args

define process_data(train_dir,test_dir,valid_dir):
...
def valid_model(model,testloader,device,criterion):
    test_losses=[]
    for e in range(epochs):
        test_loss=0
        accuracy=0
